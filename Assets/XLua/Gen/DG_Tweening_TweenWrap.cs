...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 69, 23, 18);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GotoWithCallbacks", _m_GotoWithCallbacks);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IsLoopingOrExecutingBackwards", _m_IsLoopingOrExecutingBackwards);
        ...
        static int _m_Done(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.Done(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GotoWithCallbacks(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.GotoWithCallbacks( _to, _andPlay );
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.GotoWithCallbacks( _to );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Tween.GotoWithCallbacks!");
        ...
        static int _m_ManualUpdate(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ManualUpdate( _deltaTime, _unscaledDeltaTime );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsLoopingOrExecutingBackwards(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsLoopingOrExecutingBackwards(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_SetInverted(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.SetInverted(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _inverted = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetInverted( _inverted );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Tween.SetInverted!");
