...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaProfilerHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaProfilerHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "LuaProfilerHelper does not have a constructor!");
        }
        ...
        static int _m_BeginSample_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaProfilerHelper.BeginSample( _name );
