...
namespace XLua.LuaDLL
{
    public partial class Lua
    {
        ...
        public static extern int luaopen_msgpack(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadMsgpack(System.IntPtr L)
        {
            return luaopen_msgpack(L);
        }
    }
}
    ...
    public class LuaEnv : IDisposable
    {
        ...
        public LuaEnv()
        {
...
#endif
            {
                ...
                AddBuildin("msgpack", LuaDLL.Lua.LoadMsgpack);
